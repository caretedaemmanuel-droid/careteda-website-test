    ...
    <section class="glow-bg min-h-screen bg-black text-white pt-24 pb-40 px-4 md:px-8">
      <div class="max-w-[1200px] mx-auto">
        ...
        <p class="text-white/90 text-base md:text-lg mb-8">
          Insights on AI-native chip design, EDA, and semiconductor engineering from the CaretEDA
          team.
        </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          ...
          >
            ...
            <div
              class="w-full h-36 bg-[#0d1f3c] flex items-center justify-center"
              *ngIf="!post.image"
            >
            ...
            <div class="p-5 md:p-6">
              ...
              <h3
                class="text-white font-bold text-lg md:text-xl leading-snug mb-3 group-hover:text-[#2563EB] transition-colors duration-300"
              >
                {{ post.title }}
              </h3>
              <p class="text-white/90 text-sm leading-relaxed mb-4 line-clamp-3">
                {{ post.summary }}
              </p>
...
export class BlogListComponent implements OnInit {
  ...
  posts = [
    ...
    },
    {
      ...
      summary:
        'How a tool born at Digital Equipment Corporation in 1994 ended up at the center of chip verification for Tesla, Google, AMD, and NVIDIA.',
    },
    {
    ...
    },
    {
      ...
      summary:
        'Rising chip design complexity, shrinking tapeout cycles, and why the $775B semiconductor market is making AI-driven design a strategic necessity.',
    },
  ];
}
